...
import org.springframework.security.core.Authhentication;
...
public class UserService {
    ...
    public User update(Long id, UserUpdateRequest request){
        ...
        //Validar el coordinador no pueda modificar el admini principal 
    ...
    private Boolean isCoordinator(){
        Authhentication authhentication = SecurityContextHolder .getContext().getAuthentication();
    }
    ...
    public void delete(Long id){
        ...
        //Vailiar que no se elimine el usuario admin principal
        if (id == 1L && isCoordinator()) {
